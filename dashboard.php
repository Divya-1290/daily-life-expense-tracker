            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                      ...
                      <li><a class='active-menu'  href='dashboard.php'><i class='fa fa-keyboard-o fa-2x'></i>Expense</a></li>";
                      
                       
                    </li>
                    <li  >
                       
                 <li><a  href="expense_category.php"><i class="fa fa-cog fa-2x" aria-hidden="true"></i>Create Expense</a></li>'
                     </li>				
					<li>
